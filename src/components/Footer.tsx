...
import { Activity, Shield, HeartHandshake, FileText, ExternalLink, AlertTriangle } from 'lucide-react';
    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-800">
          ...
          {/* Architecture Ready Info */}
          <div className="space-y-3">
            <h4 className="text-white text-xs font-bold uppercase tracking-wider">Developer Stack</h4>
            <p className="text-slate-400 text-xs leading-relaxed">
              Designed for seamless integration with FastAPI REST microservices, PostgreSQL relational DB, Supabase Storage, and Tesseract OCR engine.
            </p>
            <div className="flex flex-wrap gap-1.5 pt-1">
              {['React', 'TypeScript', 'Tailwind', 'FastAPI Ready', 'Supabase Ready'].map((tech) => (
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-slate-400 text-xs gap-4">
          <p>© {new Date().getFullYear()} HealthLens AI. Designed for Hackathon Demo & Personal Recovery Guidance.</p>
